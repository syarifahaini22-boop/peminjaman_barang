    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <div class="input-group" style="width: 300px;">
                ...
                <input type="text" class="form-control date-range-picker" placeholder="Pilih Periode">
            </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-success">
                                <i class="fas fa-chart-line me-1"></i> {{ number_format($mahasiswa->avg('total_peminjaman'), 1) }} rata-rata
                            </small>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-info">
                                <i class="fas fa-graduation-cap me-1"></i> {{ $jurusanStats->sortByDesc('total')->first()->jurusan ?? 'N/A' }}
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-header bg-white border-0 py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="input-group" style="width: 250px;">
                            <input type="text" class="form-control" placeholder="Cari mahasiswa..." id="searchMahasiswa">
                        ...
                        <table class="table table-hover mb-0" id="mahasiswaTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="progress flex-grow-1 me-2" style="height: 6px;">
                                                <div class="progress-bar bg-primary" style="width: {{ min($mhs->total_peminjaman * 10, 100) }}%"></div>
                                            </div>
                                    ...
                                    <td>
                                        @php
                                            $status = $mhs->total_peminjaman > 10 ? 'Aktif' : 
                                                     ($mhs->total_peminjaman > 5 ? 'Sedang' : 'Pasif');
                                            $color = $mhs->total_peminjaman > 10 ? 'success' : 
                                                    ($mhs->total_peminjaman > 5 ? 'warning' : 'secondary');
                                        @endphp
                                    ...
                                    <td class="text-end pe-4">
                                        <button class="btn btn-sm btn-outline-primary btn-detail" data-bs-toggle="modal" 
                                                data-bs-target="#detailModal" data-id="{{ $mhs->id }}">
