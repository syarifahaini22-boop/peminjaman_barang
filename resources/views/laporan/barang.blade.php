    ...
    <div class="card mb-4">
        <div class="card-header">
            <h5 class="card-title mb-0">
                <i class="fas fa-chart-pie"></i> Distribusi Kategori Barang
            </h5>
        </div>
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="list-group">
                        @foreach($stats['kategori'] as $kategori)
                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                {{ $kategori->kategori }}
                                <span class="badge bg-primary rounded-pill">{{ $kategori->total }}</span>
                            </div>
                        @endforeach
                    </div>
                </div>
                    ...
                    <tbody>
                        @foreach($barang as $index => $item)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge bg-{{ $status == 'tersedia' ? 'success' : ($status == 'hampir habis' ? 'warning' : 'danger') }}">
                                        {{ $tersedia }}
                                    </span>
                                </td>
                                <td class="text-center">
