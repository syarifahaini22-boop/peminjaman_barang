                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-success">
                                <i class="fas fa-user-plus me-1"></i> {{ App\Models\User::where('role', 'mahasiswa')->whereMonth('created_at', date('m'))->count() }} baru
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bold mb-0">{{ App\Models\Peminjaman::whereMonth('tanggal_peminjaman', date('m'))->count() }}</h3>
                            <small class="text-warning">
                                <i class="fas fa-chart-line me-1"></i> {{ number_format((App\Models\Peminjaman::whereMonth('tanggal_peminjaman', date('m'))->count() / max(App\Models\Peminjaman::whereMonth('tanggal_peminjaman', date('m', strtotime('-1 month')))->count(), 1)) * 100, 0) }}% vs bulan lalu
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bold mb-0">{{ App\Models\Peminjaman::whereMonth('tanggal_dikembalikan', date('m'))->count() }}</h3>
                            <small class="text-info">
                                <i class="fas fa-check-circle me-1"></i> {{ number_format((App\Models\Peminjaman::whereMonth('tanggal_dikembalikan', date('m'))->where('status', 'dikembalikan')->count() / max(App\Models\Peminjaman::whereMonth('tanggal_dikembalikan', date('m'))->count(), 1)) * 100, 0) }}% tepat waktu
                            </small>
                        </div>
                    </div>
                </div>
    ...
    <div class="row mb-4">
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-white border-0 py-3">
                    <h6 class="fw-bold mb-0">
                        <i class="fas fa-chart-line text-primary me-2"></i>Trend Peminjaman
                    </h6>
                </div>
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-white border-0 py-3">
                    <h6 class="fw-bold mb-0">
                        <i class="fas fa-chart-pie text-success me-2"></i>Status Peminjaman
                    </h6>
                </div>
                <div class="card-body p-3">
                    <canvas id="miniStatusChart" height="150"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-md-12 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-white border-0 py-3">
                    <h6 class="fw-bold mb-0">
                        <i class="fas fa-bullseye text-warning me-2"></i>Target Bulan Ini
                    </h6>
                </div>
                <div class="card-body">
                    <div class="text-center">
                        <div class="position-relative d-inline-block">
                            <canvas id="targetChart" width="120" height="120"></canvas>
                            <div class="position-absolute top-50 start-50 translate-middle">
                                <h4 class="fw-bold mb-0">{{ number_format((App\Models\Peminjaman::whereMonth('tanggal_peminjaman', date('m'))->count() / 50) * 100, 0) }}%</h4>
                                <small class="text-muted">Pencapaian</small>
                            </div>
                        </div>
                        <div class="mt-3">
                            <p class="mb-1">Target: 50 peminjaman</p>
                            <p class="mb-0">Tercapai: {{ App\Models\Peminjaman::whereMonth('tanggal_peminjaman', date('m'))->count() }} peminjaman</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-6 mb-4">
            <div class="card border-0 shadow-sm h-100 hover-card">
                ...
                <div class="card-body">
                    <p class="card-text text-muted">Analisis lengkap data peminjaman barang dengan berbagai filter dan statistik.</p>
                    <div class="mb-3">
        ...
        <div class="col-xl-4 col-lg-6 mb-4">
            <div class="card border-0 shadow-sm h-100 hover-card">
                ...
                <div class="card-body">
                    <p class="card-text text-muted">Monitoring pengembalian barang dan analisis tingkat keterlambatan.</p>
                    <div class="mb-3">
        ...
        <div class="col-xl-4 col-lg-6 mb-4">
            <div class="card border-0 shadow-sm h-100 hover-card">
                ...
                <div class="card-body">
                    <p class="card-text text-muted">Analisis aktivitas peminjaman berdasarkan mahasiswa dan jurusan.</p>
                    <div class="mb-3">
            ...
            <div class="card border-0 shadow-sm h-100 hover-card">
                <div class="card-header bg-white border-0 py-3 d-flex align-items-center">
                    <div class="icon-wrapper bg-danger bg-opacity-10 rounded-circle p-2 me-3">
                        <i class="fas fa-file-export text-danger fs-5"></i>
                    </div>
                    <div>
                        <h5 class="fw-bold mb-0">Export Data</h5>
                        <small class="text-muted">Excel, PDF, dan format lainnya</small>
                    </div>
                </div>
                <div class="card-body">
                    <p class="card-text text-muted">Export data ke berbagai format untuk kebutuhan dokumentasi dan presentasi.</p>
                    <div class="mb-3">
                        <span class="badge bg-danger bg-opacity-10 text-danger me-2">Export Excel</span>
                        <span class="badge bg-danger bg-opacity-10 text-danger me-2">Export PDF</span>
                        <span class="badge bg-danger bg-opacity-10 text-danger">Custom Periode</span>
                    </div>
                    <div class="d-flex align-items-center text-muted mb-3">
                        <i class="fas fa-download me-2"></i>
                        <small>Download data dengan filter yang lengkap</small>
                    </div>
                </div>
                <div class="card-footer bg-white border-0 pt-0">
                    <div class="row g-2">
                        <div class="col-6">
                            <a href="{{ route('laporan.export.excel') }}" class="btn btn-outline-success w-100">
                                <i class="fas fa-file-excel me-1"></i> Excel
                            </a>
                        </div>
                        <div class="col-6">
                            <a href="{{ route('laporan.export.pdf') }}" class="btn btn-outline-danger w-100">
        ...
        <div class="col-xl-4 col-lg-6 mb-4">
            <div class="card border-0 shadow-sm h-100 hover-card">
                ...
                <div class="card-body">
                    <p class="card-text text-muted">Dashboard interaktif dengan berbagai grafik dan visualisasi data.</p>
                    <div class="mb-3">
                ...
                <div class="card-footer bg-white border-0 pt-0">
                    <button type="button" class="btn btn-secondary w-100" data-bs-toggle="modal" data-bs-target="#statistikModal">
        ...
        <div class="modal-content border-0 shadow-lg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card border-0 shadow-sm h-100">
                                    ...
                                    <div class="card-body">
                                        @php
                                            $topBarang = App\Models\Barang::withCount(['peminjaman as peminjaman_count'])
                                        ...
                                        <div class="list-group list-group-flush">
                                            ...
                                            <div class="list-group-item border-0 px-0">
                                                <div class="d-flex align-items-center">
                                                    <div class="rank-circle bg-primary text-white fw-bold me-3">{{ $index + 1 }}</div>
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-1">{{ $barang->nama }}</h6>
                                                        <small class="text-muted">{{ $barang->kategori }}</small>
                                                    </div>
                                                    <div class="text-end">
                                                        <div class="fw-bold text-primary">{{ $barang->peminjaman_count }} kali</div>
                                                        <div class="progress" style="height: 4px; width: 100px;">
                                                            <div class="progress-bar bg-primary" style="width: {{ min($barang->peminjaman_count * 20, 100) }}%"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="card border-0 shadow-sm h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="list-group list-group-flush">
                                            ...
                                            <div class="list-group-item border-0 px-0">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-circle-sm bg-success bg-opacity-10 text-success me-3">
                                                    ...
                                                    <div class="text-end">
                                                        <div class="fw-bold text-success">{{ $mahasiswa->peminjaman_count }} kali</div>
                                                        <small class="text-muted">{{ round(($mahasiswa->peminjaman_count / max($topMahasiswa[0]->peminjaman_count, 1)) * 100, 0) }}% dari tertinggi</small>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
            ...
            <div class="modal-footer border-0">
                ...
                <button type="button" class="btn btn-primary" onclick="printDashboard()">
                    <i class="fas fa-print me-1"></i>Cetak Dashboard
                </button>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
        ...
        data: {
            datasets: [{
                data: [{{ App\Models\Peminjaman::whereMonth('tanggal_peminjaman', date('m'))->count() }}, 
                       50 - {{ App\Models\Peminjaman::whereMonth('tanggal_peminjaman', date('m'))->count() }}],
    ...
    new Chart(jurusanCtx, {
        type: 'bar',
        data: {
            labels: ['Teknik Informatika', 'Sistem Informasi', 'Teknik Elektro', 'Manajemen', 'Akuntansi'],
            datasets: [{
