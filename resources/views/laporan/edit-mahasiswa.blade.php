                    ...
                    <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('fakultas') is-invalid @enderror" 
                                       id="fakultas" name="fakultas" value="{{ old('fakultas', $mahasiswa->fakultas) }}" required>
                                @error('fakultas')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <div>
                                ...
                                <a href="{{ route('mahasiswa.show', $mahasiswa->id) }}" class="btn btn-info">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        ...
                        <div class="col-md-3">
                            <h3 class="text-warning">{{ $stats['peminjaman_aktif'] }}</h3>
                            <p class="text-muted mb-0">Sedang Dipinjam</p>
                        </div>
                        <div class="col-md-3">
                            <h3 class="text-success">{{ $stats['dikembalikan'] }}</h3>
                            <p class="text-muted mb-0">Sudah Dikembalikan</p>
                        </div>
                        <div class="col-md-3">
                            <h3 class="text-danger">{{ $stats['terlambat'] }}</h3>
