            ...
            <div class="card card-custom mb-4">
                ...
                <div class="card-body text-center">
                    @if($barang->gambar)
                        ...
                        <div class="mt-2">
                            <a href="{{ asset('storage/' . $barang->gambar) }}" 
...
<div class="card card-custom">
    ...
    <div class="card-body">
        <div class="d-grid gap-2">
            ...
            <a href="#" class="btn btn-custom btn-custom-success">
                <i class="bi bi-calendar-plus me-2"></i> Pinjam Barang Ini
            </a>
            @endif
            ...
            <button class="btn btn-custom btn-custom-info">
                ...
                <div class="card-body">
                    @if($barang->status == 'dipinjam')
                        <div class="alert alert-warning">
                            ...
                            <p class="mb-0">Barang ini sedang dalam status dipinjam dan tidak tersedia untuk peminjaman lain.</p>
                        </div>
                    @elseif($barang->status == 'rusak')
                        <div class="alert alert-danger">
                            <h6><i class="bi bi-tools me-2"></i> Barang Rusak</h6>
                            <p class="mb-0">Barang ini dalam kondisi rusak dan tidak dapat dipinjam. Perlu perbaikan.</p>
                        </div>
