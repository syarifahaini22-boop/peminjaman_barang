...
<div class="d-flex justify-content-between mt-4">
    ...
    <div class="btn-group">
        <a href="{{ route('barang.show', $barang->id) }}" class="btn btn-custom btn-custom-info me-2">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('kategori') is-invalid @enderror" 
                                    ...
                                    <option value="alat_lab" {{ old('kategori', $barang->kategori) == 'alat_lab' ? 'selected' : '' }}>Alat Lab</option>
                                    <option value="buku" {{ old('kategori', $barang->kategori) == 'buku' ? 'selected' : '' }}>Buku</option>
