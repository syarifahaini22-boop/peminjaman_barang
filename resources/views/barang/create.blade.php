            ...
            <form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control form-control-custom @error('kode_barang') is-invalid @enderror" 
    ...
    @enderror
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select form-control-custom @error('kategori') is-invalid @enderror" 
                            ...
                            <option value="alat_lab" {{ old('kategori') == 'alat_lab' ? 'selected' : '' }}>Alat Laboratorium</option>
                            <option value="buku" {{ old('kategori') == 'buku' ? 'selected' : '' }}>Buku & Referensi</option>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control form-control-custom @error('merek') is-invalid @enderror" 
                               id="merek" name="merek" 
                               value="{{ old('merek') }}"
                               placeholder="Contoh: Asus, Fluke, dll">
                        @error('merek')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control form-control-custom @error('lokasi') is-invalid @enderror" 
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control form-control-custom @error('tahun_pengadaan') is-invalid @enderror" 
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <textarea class="form-control form-control-custom @error('deskripsi') is-invalid @enderror" 
                                  ...
                                  placeholder="Deskripsi detail tentang barang">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
